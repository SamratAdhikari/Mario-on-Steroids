...
class Agent:
    def __init__(self, input_dims, num_actions):
        ...
        self.epsilon = 1.0 # to encourage exploration
        self.eps_decay = 0.99999975 # * epsilon after every time step
        self.eps_min = 0.1 # min epsilon to encourage some exploration
        self.batch_size = 32
        self.sync_network_rate = 10_000 # time to sync target network weights with online network's
